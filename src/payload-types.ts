...
export interface Offer {
  ...
  title: string;
  /**
   * Short copy shown in cards and previews.
   */
  summary: string;
  status?: ('unclaimed' | 'ready' | 'claimed') | null;
  /**
   * Optional. Controls when the offer begins showing.
   */
  startsAt?: string | null;
  expiresAt: string;
  tags?: ('featured' | 'nearby' | 'this-week')[] | null;
  /**
   * Image displayed with the offer.
   */
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        carousel?: T | HeroCarouselBlockSelect<T>;
      };
  meta?:
    | T
    | {
