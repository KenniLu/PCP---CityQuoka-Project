...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "events" (
  	...
  	"venue_id" integer,
  	"event_start_datetime" timestamp(3) with time zone,
  	"event_end_datetime" timestamp(3) with time zone,
  	"slug" varchar,
  	"slug_lock" boolean DEFAULT true,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  ...
  CREATE TABLE IF NOT EXISTS "programmes_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  DO $$ BEGIN
   ALTER TABLE "posts" ADD CONSTRAINT "posts_venue_id_venues_id_fk" FOREIGN KEY ("venue_id") REFERENCES "public"."venues"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "posts_rels" ADD CONSTRAINT "posts_rels_programmes_fk" FOREIGN KEY ("programmes_id") REFERENCES "public"."programmes"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_posts_v" ADD CONSTRAINT "_posts_v_version_venue_id_venues_id_fk" FOREIGN KEY ("version_venue_id") REFERENCES "public"."venues"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "programmes" ADD CONSTRAINT "programmes_banner_id_media_id_fk" FOREIGN KEY ("banner_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "programmes_rels" ADD CONSTRAINT "programmes_rels_categories_fk" FOREIGN KEY ("categories_id") REFERENCES "public"."categories"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "programmes_rels" ADD CONSTRAINT "programmes_rels_events_fk" FOREIGN KEY ("events_id") REFERENCES "public"."events"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "events_banner_idx" ON "events" USING btree ("banner_id");
  ...
  CREATE INDEX IF NOT EXISTS "programmes_banner_idx" ON "programmes" USING btree ("banner_id");
  CREATE INDEX IF NOT EXISTS "programmes_slug_idx" ON "programmes" USING btree ("slug");
  CREATE INDEX IF NOT EXISTS "programmes_updated_at_idx" ON "programmes" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "programmes_created_at_idx" ON "programmes" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "programmes_rels_order_idx" ON "programmes_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "programmes_rels_parent_idx" ON "programmes_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "programmes_rels_path_idx" ON "programmes_rels" USING btree ("path");
  CREATE INDEX IF NOT EXISTS "programmes_rels_categories_id_idx" ON "programmes_rels" USING btree ("categories_id");
  CREATE INDEX IF NOT EXISTS "programmes_rels_events_id_idx" ON "programmes_rels" USING btree ("events_id");
  CREATE INDEX IF NOT EXISTS "venues_image_idx" ON "venues" USING btree ("image_id");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_programmes_id_idx" ON "payload_locked_documents_rels" USING btree ("programmes_id");
